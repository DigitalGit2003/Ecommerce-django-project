...
class CustomerRegistrationForm(UserCreationForm):
    ...
    email = forms.CharField(label='Email', required=True, widget=forms.EmailInput(attrs={'class':'form-control'}))   # labels = {'email':'Email'}   ,in meta class.... , 2nd technique to give label to an input of form 
    class Meta:
        model = User
